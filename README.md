...
### Prerequisites
- .NET 10.0 SDK or compatible IDE (Visual Studio 2022 / JetBrains Rider).
...
Pre-compiled binaries are available in [GitHub Releases](https://github.com/uasdiuduiasdasd/SP-onverter/releases).
